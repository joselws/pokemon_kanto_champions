...
; Characteristics of each move.
	...
	;    name		   effect                      pow  type          acc  pp
	move POUND,        NO_ADDITIONAL_EFFECT,        40, NORMAL,       100, 35
	move KARATE_CHOP,  NO_ADDITIONAL_EFFECT,        60, FIGHTING,     100, 25
	...
	move VICEGRIP,     FLINCH_SIDE_EFFECT2,         80, BUG,          100, 30
	move GUILLOTINE,   OHKO_EFFECT,                  1, NORMAL,        30,  5
	move RAZOR_WIND,   CHARGE_EFFECT,              195, BUG,          100, 10
	move SWORDS_DANCE, ATTACK_UP2_EFFECT,            0, NORMAL,       100, 30
	move CUT,          NO_ADDITIONAL_EFFECT,        55, BUG,           95, 30
	move GUST,         NO_ADDITIONAL_EFFECT,        40, FLYING,       100, 35
	move WING_ATTACK,  NO_ADDITIONAL_EFFECT,        75, FLYING,       100, 35
	...
	move MEGA_KICK,    NO_ADDITIONAL_EFFECT,       120, NORMAL,        90,  5
	move JUMP_KICK,    JUMP_KICK_EFFECT,           100, FIGHTING,      95, 25
	move ROLLING_KICK, FLINCH_SIDE_EFFECT2,         85, FIGHTING,     100, 15
	move SAND_ATTACK,  ACCURACY_DOWN1_EFFECT,        0, NORMAL,       100, 15
	move HEADBUTT,     FLINCH_SIDE_EFFECT2,         70, NORMAL,       100, 15
	move HORN_ATTACK,  NO_ADDITIONAL_EFFECT,        65, NORMAL,       100, 25
	move FURY_ATTACK,  TWO_TO_FIVE_ATTACKS_EFFECT,  25, BUG,          100, 20
	move HORN_DRILL,   OHKO_EFFECT,                  1, NORMAL,        30,  5
	move TACKLE,       NO_ADDITIONAL_EFFECT,        35, NORMAL,        95, 35
	move BODY_SLAM,    PARALYZE_SIDE_EFFECT2,       85, NORMAL,       100, 15
	move WRAP,         TRAPPING_EFFECT,             15, NORMAL,        85, 20
	move TAKE_DOWN,    RECOIL_EFFECT,              150, NORMAL,        85, 20
	...
	move TWINEEDLE,    TWINEEDLE_EFFECT,            60, BUG,          100, 20
	...
	move PSYBEAM,      CONFUSION_SIDE_EFFECT,       75, PSYCHIC_TYPE, 100, 20
	move BUBBLEBEAM,   SPEED_DOWN_SIDE_EFFECT,      65, WATER,        100, 20
	move AURORA_BEAM,  ATTACK_DOWN_SIDE_EFFECT,    105, ICE,           95, 20
	...
	move STRENGTH,     NO_ADDITIONAL_EFFECT,        95, FIGHTING,     100, 15
	...
	move PETAL_DANCE,  NO_ADDITIONAL_EFFECT,       115, GRASS,         95, 20
	move STRING_SHOT,  SPEED_DOWN1_EFFECT,           0, BUG,           95, 40
	move DRAGON_RAGE,  NO_ADDITIONAL_EFFECT,        95, DRAGON,       100, 10
	...
	move SKULL_BASH,   CHARGE_EFFECT,              240, NORMAL,       100, 15
	...
	move HI_JUMP_KICK, JUMP_KICK_EFFECT,           105, FIGHTING,      95, 20
	...
	move SKY_ATTACK,   CHARGE_EFFECT,              235, FLYING,       100,  5
	move TRANSFORM,    TRANSFORM_EFFECT,             0, NORMAL,       100, 10
	move BUBBLE,       SPEED_DOWN_SIDE_EFFECT,      20, WATER,        100, 30
	move DIZZY_PUNCH,  CONFUSION_SIDE_EFFECT,       90, NORMAL,       100, 10
	move SPORE,        PARALYZE_SIDE_EFFECT2,       85, GHOST,        100, 15
	...
	move SLASH,        NO_ADDITIONAL_EFFECT,        95, NORMAL,       100, 20
