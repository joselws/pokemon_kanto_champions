...
; Route 20
	db 63, ONIX, FEAROW, PIKACHU, FEAROW, SCYTHER, MAROWAK, 0
; Rock Tunnel 1F
...
; Route 20
	db 63, PORYGON, VAPOREON, PIDGEOT, NIDOQUEEN, FARFETCHD, ONIX, 0
...
; Route 21
	db 63, PIKACHU, CLOYSTER, KABUTOPS, PERSIAN, NINETALES, ZAPDOS, 0
	db 63, ARTICUNO, EXEGGUTOR, TENTACRUEL, SNORLAX, DRAGONITE, HITMONLEE, 0
	db 63, NIDOQUEEN, MR_MIME, PARASECT, DRAGONITE, KANGASKHAN, PIDGEOT, 0
	db 63, CHANSEY, BLASTOISE, KINGLER, MACHAMP, VILEPLUME, HYPNO, 0
; Route 12
...
; Route 19
	db 63, NIDOQUEEN, DRAGONITE, PINSIR, VICTREEBEL, CHARIZARD, HYPNO, 0
	db 63, ALAKAZAM, FEAROW, RAICHU, TENTACRUEL, NINETALES, DODRIO, 0
	db 63, RATICATE, WEEZING, NIDOQUEEN, JYNX, STARMIE, VENUSAUR, 0
	db 63, VICTREEBEL, NIDOKING, MOLTRES, RHYDON, SLOWBRO, HITMONLEE, 0
	db 63, HYPNO, RHYDON, PERSIAN, GOLBAT, ELECTABUZZ, HITMONLEE, 0
	db 63, CLOYSTER, TAUROS, VAPOREON, DODRIO, BLASTOISE, STARMIE, 0
	db 63, SANDSLASH, NIDOQUEEN, PARASECT, MUK, GOLEM, STARMIE, 0
; Route 20
	db 63, ONIX, GENGAR, SANDSLASH, FLAREON, HITMONLEE, NIDOQUEEN, 0
	db 63, BLASTOISE, PIDGEOT, ARBOK, CLOYSTER, CHANSEY, ARCANINE, 0
	db 63, VILEPLUME, GOLDUCK, GYARADOS, OMASTAR, HYPNO, PORYGON, 0
; Route 21
	db 63, TAUROS, PIDGEOT, DEWGONG, DODRIO, PARASECT, VENUSAUR, 0
	db 63, POLIWRATH, KABUTOPS, MACHAMP, HYPNO, RAPIDASH, MOLTRES, 0
	db 63, MR_MIME, LICKITUNG, RATICATE, MR_MIME, FARFETCHD, SLOWBRO, 0
	db 63, HYPNO, LICKITUNG, EXEGGUTOR, ARBOK, WEEZING, AERODACTYL, 0
...
; Route 21
	db 63, VAPOREON, VENUSAUR, NINETALES, ALAKAZAM, SEAKING, RAICHU, 0
...
; Route 20
	db 63, FEAROW, FARFETCHD, RATICATE, KABUTOPS, DEWGONG, DRAGONITE, 0
	db 63, HITMONLEE, NIDOKING, GOLDUCK, NIDOKING, MOLTRES, GYARADOS, 0
	db 63, SANDSLASH, DITTO, CHARIZARD, ALAKAZAM, ELECTABUZZ, TENTACRUEL, 0
; Route 15
...
; Route 19
	db 63, SEAKING, CLOYSTER, ONIX, GOLEM, BLASTOISE, HYPNO, 0
	db 63, DITTO, RHYDON, SANDSLASH, TENTACRUEL, RHYDON, MAROWAK, 0
	db 63, DEWGONG, JYNX, KINGLER, CHARIZARD, SEADRA, NIDOQUEEN, 0
; Route 20
	db 63, OMASTAR, MACHAMP, RHYDON, DUGTRIO, MAGMAR, PIKACHU, 0
...
; Route 20
	db 63, CHARIZARD, PIKACHU, BEEDRILL, CLOYSTER, VENOMOTH, DUGTRIO, 0
; Unused
