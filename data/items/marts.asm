...
CeruleanMartClerkText::
	script_mart POKE_BALL, POTION, SUPER_POTION, REPEL, ANTIDOTE, BURN_HEAL, AWAKENING, PARLYZ_HEAL

UnusedBikeShopClerkText:: ; unreferenced
	script_mart BICYCLE

VermilionMartClerkText::
	script_mart POKE_BALL, SUPER_POTION, ICE_HEAL, AWAKENING, PARLYZ_HEAL, REPEL, REVIVE
...
CeladonMart2FClerk2Text::
	script_mart TM_ROCK_SLIDE, TM_EARTHQUAKE, TM_RAZOR_WIND, TM_ICE_BEAM, TM_THUNDERBOLT, TM_PSYCHIC_M, TM_BODY_SLAM, TM_SOLARBEAM, TM_SKY_ATTACK, TM_EXPLOSION
